<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
        ...
        <table width="100%">
            <tr>
                ...
                <td align="right">Designed for use with <a href="http://www.junit.org/">JUnit</a> and <a
                        href="http://ant.apache.org/">Ant</a>. Screenshots of failed tests taken by <a
                        href="http://assertj.org/assertj-swing.html">AssertJ Swing</a>.
                </td>
            </tr>
        </table>
        <hr size="1"/>
    ...
    <xsl:template match="screenshot">
        ...
        <xsl:variable name="screenshot.fullpath">
            <xsl:value-of select="$output.dir"/><xsl:text>/</xsl:text><xsl:value-of select="$package.dir"/><xsl:text>/</xsl:text><xsl:value-of
        ...
        <xsl:value-of
                select="java:org.assertj.swing.junit.ant.ImageHandler.decodeBase64AndSaveAsPng(string($encoded.image), string($screenshot.fullpath))"/>
        <div>
            <br/>
            <a>
                <xsl:attribute name="href">
                    <xsl:value-of select="$screenshot.path"/>
                </xsl:attribute>
