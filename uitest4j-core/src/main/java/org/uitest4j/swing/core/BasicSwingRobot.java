...
/**
 * Default implementation of {@link SwingRobot}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 ...
 * @see SwingRobot
 */
public class BasicSwingRobot implements SwingRobot {
	...
	/**
	 * Creates a new {@link SwingRobot} with a new AWT hierarchy. The created {@code SwingRobot} will not be able to access any AWT
	 * and Swing {@code Component}s that were created before it.
	 *
	 * @return the created {@code SwingRobot}.
	 */
	@Nonnull
	public static SwingRobot robotWithNewAwtHierarchy() {
		Object screenLockOwner = acquireScreenLock();
		return new BasicSwingRobot(screenLockOwner, ignoreExistingComponents());
	}

	@Nonnull
	public static SwingRobot robotWithNewAwtHierarchyWithoutScreenLock() {
		return new BasicSwingRobot(null, ignoreExistingComponents());
	}

	/**
	 * Creates a new {@link SwingRobot} that has access to all the AWT and Swing {@code Component}s in the AWT hierarchy.
	 *
	 * @return the created {@code SwingRobot}.
	 */
	@Nonnull
	public static SwingRobot robotWithCurrentAwtHierarchy() {
		Object screenLockOwner = acquireScreenLock();
		return new BasicSwingRobot(screenLockOwner, new ExistingHierarchy());
	}

	// TODO document
	@Nonnull
	public static SwingRobot robotWithCurrentAwtHierarchyWithoutScreenLock() {
		return new BasicSwingRobot(null, new ExistingHierarchy());
	}
	...
	// Used for tests
	BasicSwingRobot(@Nullable Object screenLockOwner, @Nonnull ComponentHierarchy hierarchy) {
