...
public class JSliderDriver extends JComponentDriver {
	 ...
	 */
	public JSliderDriver(@Nonnull SwingRobot robot) {
		super(robot);
	...
	@RunsInEDT
	@Nonnull
	private static Pair<Integer, GenericRange<Point>> findSlideToMaximumInfo(final @Nonnull JSlider slider,
	...
	@RunsInEDT
	@Nonnull
	private static Pair<Integer, GenericRange<Point>> findSlideToMinimumInfo(final @Nonnull JSlider slider,
																			 final @Nonnull JSliderLocation location) {
		Pair<Integer, GenericRange<Point>> result = execute(new GuiQuery<>() {
			@Override
			protected Pair<Integer, GenericRange<Point>> executeInEDT() {
	...
	@RunsInEDT
	@Nonnull
	private static GenericRange<Point> findSlideInfo(final @Nonnull JSlider slider,
