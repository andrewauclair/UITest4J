...
public class JTableHeaderDriver extends JComponentDriver {
	 ...
	 */
	public JTableHeaderDriver(@Nonnull SwingRobot robot) {
		super(robot);
	}
	...
	@RunsInEDT
	@Nonnull
	private static Point pointAtIndex(final @Nonnull JTableHeader tableHeader, final int columnIndex,
	...
	@RunsInEDT
	@Nonnull
	private static Point pointAtName(final @Nonnull JTableHeader tableHeader,
