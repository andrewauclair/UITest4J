...
public class JListFixture extends AbstractJPopupMenuInvokerFixture<JListFixture, JList, JListDriver> implements
	 ...
	 */
	@Nonnull
	public JListFixture selectItems(@Nonnull int... indices) {
	 ...
	 */
	@Nonnull
	public JListFixture unselectItems(@Nonnull int... indices) {
	 ...
	 */
	@Nonnull
	public JListFixture selectItems(@Nonnull String... items) {
	 ...
	 */
	@Nonnull
	public JListFixture selectItems(@Nonnull Pattern... patterns) {
	 ...
	 */
	@Nonnull
	public JListFixture requireSelectedItems(@Nonnull int... indices) {
	 ...
	 */
	@Nonnull
	public JListFixture requireSelectedItems(@Nonnull String... items) {
