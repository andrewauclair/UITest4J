...
public class JProgressBarFixture extends
	...
	@Override
	@Nonnull
	public JProgressBarFixture requireText(@Nonnull Pattern pattern) {
	 ...
	 */
	@Nonnull
	public JProgressBarFixture waitUntilValueIs(int value, @Nonnull Timeout timeout) {
	 ...
	 */
	@Nonnull
	public JProgressBarFixture waitUntilIsDeterminate(@Nonnull Timeout timeout) {
