...
public class JTableFixture extends AbstractJPopupMenuInvokerFixture<JTableFixture, JTable, JTableDriver> {
	 ...
	 */
	@Nonnull
	public JTableFixture selectCells(@Nonnull TableCell... cells) {
	 ...
	 */
	@Nonnull
	public JTableFixture selectRows(@Nonnull int... rows) {
	 ...
	 */
	@Nonnull
	public JTableFixture unselectCells(@Nonnull TableCell... cells) {
	 ...
	 */
	@Nonnull
	public JTableFixture unselectRows(@Nonnull int... rows) {
	 ...
	 * @throws IndexOutOfBoundsException                          if any of the indices (row and column) is out of bounds.
	 * @throws ActionFailedException if this fixture's {@code JTableCellValueReader} is unable
	 ...
	 */
	@Nonnull
	public JTableFixture requireSelectedRows(@Nonnull int... rows) {
