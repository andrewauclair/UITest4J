...
public class JFileChooserFixture extends
	 ...
	 * @throws org.uitest4j.swing.exception.ComponentLookupException if a matching textToMatch field could not be found.
	 */
	@Nonnull
	 ...
	 */
	@Nonnull
	public JFileChooserFixture selectFiles(@Nonnull File... files) {
	 ...
	 */
	@Nonnull
	public JFileChooserFixture setCurrentDirectory(@Nonnull File dir) {
