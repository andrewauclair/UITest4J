...
public class JInternalFrameFixture extends
	...
	@Override
	@Nonnull
	public JInternalFrameFixture requireToolTip(@Nonnull Pattern pattern) {
	...
	@Override
	@Nonnull
	public JInternalFrameFixture requireSize(@Nonnull Dimension size) {
	...
	@Override
	@Nonnull
	public JInternalFrameFixture resizeTo(@Nonnull Dimension size) {
	...
	@Override
	@Nonnull
	public JInternalFrameFixture moveTo(@Nonnull Point p) {
