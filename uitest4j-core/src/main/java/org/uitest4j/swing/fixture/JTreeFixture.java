...
public class JTreeFixture extends AbstractJPopupMenuInvokerFixture<JTreeFixture, JTree, JTreeDriver> implements
	 ...
	 */
	@Nonnull
	public JTreeFixture selectRows(@Nonnull int... rows) {
	 ...
	 */
	@Nonnull
	public JTreeFixture selectPaths(@Nonnull String... paths) {
	 ...
	 */
	@Nonnull
	public JTreeFixture unselectRows(@Nonnull int... rows) {
	 ...
	 */
	@Nonnull
	public JTreeFixture unselectPath(@Nonnull String path) {
	 ...
	 */
	@Nonnull
	public JTreeFixture unselectPaths(@Nonnull String... paths) {
	 ...
	 */
	@Nonnull
	public JTreeFixture requireSelection(@Nonnull int... rows) {
	 ...
	 */
	@Nonnull
	public JTreeFixture requireSelection(@Nonnull String... paths) {
