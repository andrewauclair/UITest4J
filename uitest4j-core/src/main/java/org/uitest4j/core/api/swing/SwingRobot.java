...
public interface SwingRobot {
	 ...
	 * {@code SwingRobot}. This method <strong>does not</strong> dispose any open windows.
	 * </p>
	 *
	 * <p>
	 ...
	 * {@code java.awt.SwingRobot.waitForIdle()}, which may have events on the queue when it returns. Do <strong>NOT</strong>
	...
	/**
	 * @return the configuration settings for this {@code SwingRobot}.
	 */
	@Nonnull
	Settings settings();

	/**
	 * Indicates whether this {@code SwingRobot} is active. Being "active" means that {@link #cleanUp()} has not been called
	 * yet.
	 *
	 * @return {@code true} if this {@code SwingRobot} is active, {@code false} otherwise.
	 */
	boolean isActive();
}