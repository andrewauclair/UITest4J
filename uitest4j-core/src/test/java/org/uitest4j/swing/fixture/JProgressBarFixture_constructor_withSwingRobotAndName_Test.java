...
/**
 * Tests for {@link JProgressBarFixture#JProgressBarFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 */
public class JProgressBarFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JProgressBarFixture_constructor_withSwingRobotAndName_Test.class);
