...
class FontFixture_requirePlain_Test extends FontFixture_TestCase {
	...
	void should_Pass_If_Font_Is_Plain() {
		FontFixture fixture = new FontFixture(font());
	...
	void should_Fail_If_Font_Is_Not_Plain() {
		...
		ExpectedException.assertOpenTest4jError(fixture::requirePlain, "Expected font to be plain");
	}

	@Test
	void should_Fail_Showing_Description_If_Font_Is_Not_Plain() {
		FontFixture fixture = new FontFixture(boldFont(), "test");
		ExpectedException.assertOpenTest4jError(fixture::requirePlain, "[test] Expected font to be plain");
	}
}
