...
/**
 * Tests for {@link JLabelFixture#JLabelFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JLabelFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JLabelFixture_constructor_withSwingRobotAndName_Test.class);
			label.setName("label");
			addComponents(label);
		}
	}
