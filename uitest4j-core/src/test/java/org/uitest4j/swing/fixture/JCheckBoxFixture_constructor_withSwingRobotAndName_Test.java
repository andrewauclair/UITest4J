...
/**
 * Tests for {@link JCheckBoxFixture#JCheckBoxFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JCheckBoxFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JCheckBoxFixture_constructor_withSwingRobotAndName_Test.class);
