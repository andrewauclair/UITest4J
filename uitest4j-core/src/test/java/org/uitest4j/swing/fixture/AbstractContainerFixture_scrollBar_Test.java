 ...
 * @author Alex Ruiz
 */
public class AbstractContainerFixture_scrollBar_Test extends SwingRobotBasedTestCase {
	...
	void should_Find_Visible_JScrollBar_By_Matcher() {
		robot.showWindow(window);
		JScrollBarFixture scrollBar = fixture.scrollBar(new GenericTypeMatcher<>(JScrollBar.class) {
			@Override
