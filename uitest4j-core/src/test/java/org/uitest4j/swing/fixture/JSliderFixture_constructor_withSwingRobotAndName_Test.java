...
/**
 * Tests for {@link JSliderFixture#JSliderFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JSliderFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JSliderFixture_constructor_withSwingRobotAndName_Test.class);
