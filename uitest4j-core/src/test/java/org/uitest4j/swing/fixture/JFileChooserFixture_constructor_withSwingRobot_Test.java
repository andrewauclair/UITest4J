...
/**
 * Tests for {@link JFileChooserFixture#JFileChooserFixture(SwingRobot)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JFileChooserFixture_constructor_withSwingRobot_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JFileChooserFixture_constructor_withSwingRobot_Test.class);
