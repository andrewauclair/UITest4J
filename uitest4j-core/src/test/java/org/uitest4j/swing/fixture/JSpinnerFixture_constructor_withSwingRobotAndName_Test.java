...
/**
 * Tests for {@link JSpinnerFixture#JSpinnerFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JSpinnerFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JSpinnerFixture_constructor_withSwingRobotAndName_Test.class);
