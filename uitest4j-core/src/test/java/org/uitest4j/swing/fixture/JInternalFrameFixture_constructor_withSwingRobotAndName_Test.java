...
/**
 * Tests for {@link JInternalFrameFixture#JInternalFrameFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JInternalFrameFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestMdiWindow {
		...
		private MyWindow() {
			super(JInternalFrameFixture_constructor_withSwingRobotAndName_Test.class);
