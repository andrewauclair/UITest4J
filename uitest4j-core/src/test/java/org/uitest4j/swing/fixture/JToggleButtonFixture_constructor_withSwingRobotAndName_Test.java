...
/**
 * Tests for {@link JToggleButtonFixture#JToggleButtonFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JToggleButtonFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JToggleButtonFixture_constructor_withSwingRobotAndName_Test.class);
