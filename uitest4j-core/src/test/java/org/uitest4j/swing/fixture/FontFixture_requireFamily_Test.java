...
class FontFixture_requireFamily_Test extends FontFixture_TestCase {
	...
	void should_Fail_If_Family_Is_Not_Equal_To_Expected() {
		ExpectedException.assertOpenTest4jError(() -> fixture().requireFamily("Monospace"), "Expected font family to be 'Monospace' but was 'SansSerif'", "Monospace", "SansSerif");
	}

	@Test
	void should_Fail_Showing_Description_If_Family_Is_Not_Equal_To_Expected() {
		FontFixture fixture = new FontFixture(font(), "test");
		ExpectedException.assertOpenTest4jError(() -> fixture.requireFamily("Monospace"), "[test] Expected font family to be 'Monospace' but was 'SansSerif'", "Monospace", "SansSerif");
	}
}
