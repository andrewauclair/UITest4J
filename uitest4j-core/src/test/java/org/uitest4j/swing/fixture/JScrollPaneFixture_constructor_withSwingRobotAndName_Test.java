...
/**
 * Tests for {@link JScrollPaneFixture#JScrollPaneFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JScrollPaneFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JScrollPaneFixture_constructor_withSwingRobotAndName_Test.class);
