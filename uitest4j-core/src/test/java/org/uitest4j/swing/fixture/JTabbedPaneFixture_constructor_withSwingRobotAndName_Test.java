...
/**
 * Tests for {@link JTabbedPaneFixture#JTabbedPaneFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JTabbedPaneFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JTabbedPaneFixture_constructor_withSwingRobotAndName_Test.class);
