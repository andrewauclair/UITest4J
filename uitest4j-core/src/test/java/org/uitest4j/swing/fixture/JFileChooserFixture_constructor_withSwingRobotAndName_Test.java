...
/**
 * Tests for {@link JFileChooserFixture#JFileChooserFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JFileChooserFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JFileChooserFixture_constructor_withSwingRobotAndName_Test.class);
