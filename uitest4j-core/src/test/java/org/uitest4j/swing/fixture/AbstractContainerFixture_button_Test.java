 ...
 * @author Alex Ruiz
 */
public class AbstractContainerFixture_button_Test extends SwingRobotBasedTestCase {
	...
	void should_Find_Visible_JButton_By_Matcher() {
		robot.showWindow(window);
		JButtonFixture button = fixture.button(new GenericTypeMatcher<>(JButton.class) {
			@Override
