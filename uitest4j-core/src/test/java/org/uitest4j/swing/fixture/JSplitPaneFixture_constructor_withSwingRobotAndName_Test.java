...
/**
 * Tests for {@link JSplitPaneFixture#JSplitPaneFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JSplitPaneFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JSplitPaneFixture_constructor_withSwingRobotAndName_Test.class);
