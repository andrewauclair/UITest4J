...
/**
 * Tests for {@link JToolBarFixture#JToolBarFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JToolBarFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JToolBarFixture_constructor_withSwingRobotAndName_Test.class);
