...
/**
 * Tests for {@link JTableFixture#JTableFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JTableFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JTableFixture_constructor_withSwingRobotAndName_Test.class);
			table.setName("table");
