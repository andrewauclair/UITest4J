 ...
 * @author Alex Ruiz
 */
public class AbstractContainerFixture_toolBar_Test extends SwingRobotBasedTestCase {
	...
	void should_Find_Visible_JToolBar_By_Matcher() {
		robot.showWindow(window);
		JToolBarFixture toolBar = fixture.toolBar(new GenericTypeMatcher<>(JToolBar.class) {
			@Override
