...
/**
 * Tests for {@link JComboBoxFixture#JComboBoxFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JComboBoxFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JComboBoxFixture_constructor_withSwingRobotAndName_Test.class);
