...
/**
 * Tests for {@link JPanelFixture#JPanelFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JPanelFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JPanelFixture_constructor_withSwingRobotAndName_Test.class);
			panel.setName("panel");
			addComponents(panel);
		}
	}
