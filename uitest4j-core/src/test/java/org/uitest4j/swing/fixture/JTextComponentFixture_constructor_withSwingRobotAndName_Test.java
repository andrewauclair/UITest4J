...
/**
 * Tests for {@link JTextComponentFixture#JTextComponentFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JTextComponentFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JTextComponentFixture_constructor_withSwingRobotAndName_Test.class);
