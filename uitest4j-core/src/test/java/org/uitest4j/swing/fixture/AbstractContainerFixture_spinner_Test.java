 ...
 * @author Alex Ruiz
 */
public class AbstractContainerFixture_spinner_Test extends SwingRobotBasedTestCase {
	...
	void should_Find_Visible_JSpinner_By_Matcher() {
		robot.showWindow(window);
		JSpinnerFixture spinner = fixture.spinner(new GenericTypeMatcher<>(JSpinner.class) {
			@Override
