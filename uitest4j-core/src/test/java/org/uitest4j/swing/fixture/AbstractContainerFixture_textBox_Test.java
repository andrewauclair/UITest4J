 ...
 * @author Alex Ruiz
 */
public class AbstractContainerFixture_textBox_Test extends SwingRobotBasedTestCase {
	...
	void should_Find_Visible_JTextComponent_By_Matcher() {
		robot.showWindow(window);
		JTextComponentFixture textBox = fixture.textBox(new GenericTypeMatcher<>(JTextComponent.class) {
			@Override
