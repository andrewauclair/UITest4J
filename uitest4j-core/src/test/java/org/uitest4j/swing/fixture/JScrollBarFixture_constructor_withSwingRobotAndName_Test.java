...
/**
 * Tests for {@link JScrollBarFixture#JScrollBarFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JScrollBarFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JScrollBarFixture_constructor_withSwingRobotAndName_Test.class);
