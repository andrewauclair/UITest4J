...
/**
 * Tests for {@link JListFixture#JListFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JListFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JListFixture_constructor_withSwingRobotAndName_Test.class);
			list.setName("list");
