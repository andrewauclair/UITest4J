 ...
 * @author Alex Ruiz
 */
public class AbstractContainerFixture_comboBox_Test extends SwingRobotBasedTestCase {
	...
	void should_Find_Visible_JComboBox_By_Matcher() {
		robot.showWindow(window);
		JComboBoxFixture comboBox = fixture.comboBox(new GenericTypeMatcher<>(JComboBox.class) {
			@Override
