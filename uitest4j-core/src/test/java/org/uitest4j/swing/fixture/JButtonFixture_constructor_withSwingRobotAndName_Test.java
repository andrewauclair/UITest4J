...
/**
 * Tests for {@link JButtonFixture#JButtonFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JButtonFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JButtonFixture_constructor_withSwingRobotAndName_Test.class);
