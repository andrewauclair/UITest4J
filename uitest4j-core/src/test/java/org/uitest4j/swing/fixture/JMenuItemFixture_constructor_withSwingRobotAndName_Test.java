...
/**
 * Tests for {@link JMenuItemFixture#JMenuItemFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JMenuItemFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JMenuItemFixture_constructor_withSwingRobotAndName_Test.class);
