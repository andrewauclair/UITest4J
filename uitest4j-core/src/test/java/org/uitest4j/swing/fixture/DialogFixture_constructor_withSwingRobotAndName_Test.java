...
/**
 * Tests for {@link DialogFixture#DialogFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
class DialogFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	@Test
