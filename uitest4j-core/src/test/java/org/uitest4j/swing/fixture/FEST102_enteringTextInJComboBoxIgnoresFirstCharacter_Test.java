 ...
 * @author Alex Ruiz
 */
public class FEST102_enteringTextInJComboBoxIgnoresFirstCharacter_Test extends SwingRobotBasedTestCase {
	@Test
	...
	private <T> JComboBoxFixture fixture(List<T> comboBoxItems) {
		MyWindow window = MyWindow.createNew(new Vector<>(comboBoxItems));
