...
/**
 * Tests for {@link JRadioButtonFixture#JRadioButtonFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JRadioButtonFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JRadioButtonFixture_constructor_withSwingRobotAndName_Test.class);
