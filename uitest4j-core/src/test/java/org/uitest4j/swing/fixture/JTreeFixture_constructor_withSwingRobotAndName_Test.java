...
/**
 * Tests for {@link JTreeFixture#JTreeFixture(SwingRobot, String)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JTreeFixture_constructor_withSwingRobotAndName_Test extends SwingRobotBasedTestCase {
	...
	private static class MyWindow extends TestWindow {
		...
		private MyWindow() {
			super(JTreeFixture_constructor_withSwingRobotAndName_Test.class);
			tree.setName("tree");
			add(decorate(tree));
		}
