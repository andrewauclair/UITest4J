...
/**
 * Tests for {@link BasicSwingRobot#findActivePopupMenu()}.
 *
 * @author Yvonne Wang
 * @author Alex Ruiz
 * @author DaveBrad
 */
public class BasicSwingRobot_findActivePopupMenu_Test extends BasicSwingRobot_TestCase {
	...
	private static JPopupMenu[] createAndSetPopupMenuWithCascade(
		...
		return execute(() -> {
			...
			return popupArr.toArray(new JPopupMenu[0]);
		});
	}
