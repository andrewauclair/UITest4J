...
/**
 * Tests for {@link BasicSwingRobot#pressKey(int)} and {@link BasicSwingRobot#releaseKey(int)}.
 *
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
class BasicSwingRobot_pressKeyAndReleaseKey_Test extends BasicSwingRobot_TestCase {
	@Test
