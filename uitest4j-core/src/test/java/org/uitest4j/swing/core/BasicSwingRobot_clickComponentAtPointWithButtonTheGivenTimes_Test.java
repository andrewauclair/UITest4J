...
/**
 * Tests for {@link BasicSwingRobot#click(java.awt.Component, java.awt.Point, MouseButton, int)}.
 *
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
class BasicSwingRobot_clickComponentAtPointWithButtonTheGivenTimes_Test extends BasicRobot_ClickTestCase {
