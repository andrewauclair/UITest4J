...
class FrameDriver_requireTitle_Test extends FrameDriver_TestCase {
	...
	void should_Fail_If_Frame_Does_Not_Have_Expected_Title() {
		ExpectedException.assertOpenTest4jError(() -> driver.requireTitle(window, "incorrect title"), "Expected title of 'TestWindow' to be 'incorrect title' but was '" + CORRECT_TITLE + "'", "incorrect title", CORRECT_TITLE);
	}
}
