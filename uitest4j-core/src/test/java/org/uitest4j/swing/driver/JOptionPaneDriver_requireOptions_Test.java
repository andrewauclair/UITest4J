...
class JOptionPaneDriver_requireOptions_Test extends JOptionPaneDriver_TestCase {
	...
	void should_Fail_If_Options_Are_Not_Equal_To_Expected() {
		...
		pack(optionPane, title());
		ExpectedException.assertOpenTest4jError(() -> driver.requireOptions(optionPane, array("Third")), "Expected options of 'TestOptionPane' to be [Third] but were [First, Second]", array("Third"), array("First", "Second"));
	}
}
