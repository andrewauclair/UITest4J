...
public class TestWindow extends JFrame {
	...
	@RunsInEDT
	@Nonnull
	public static TestWindow createAndShowNewWindow(final @Nonnull Class<?> testClass) {
	...
	@RunsInEDT
	@Nonnull
	public static TestWindow createNewWindow(final @Nonnull Class<?> testClass) {
		TestWindow result = execute(() -> createInCurrentThread(testClass));
		return Objects.requireNonNull(result);
	}

	@Nonnull
	private static TestWindow createInCurrentThread(@Nonnull Class<?> testClass) {
	...
	@RunsInCurrentThread
	@Nonnull
	protected static <T extends TestWindow> T display(@Nonnull T w) {
