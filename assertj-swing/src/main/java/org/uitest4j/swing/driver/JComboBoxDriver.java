...
import static org.uitest4j.swing.driver.JComboBoxItemCountQuery.itemCountIn;
import static org.uitest4j.swing.driver.JComboBoxItemIndexPreconditions.checkItemIndexInBounds;
import static org.uitest4j.swing.driver.JComboBoxMatchingItemQuery.matchingItemIndex;
...
public class JComboBoxDriver extends JComponentDriver {
	...
	@RunsInEDT
	@Nullable
	private static String valueAsText(final @Nonnull JComboBox<?> comboBox, final int index,
