...
class JOptionPaneDriver_requirePlainMessage_Test extends JOptionPaneDriver_TestCase {
	...
	void should_Fail_If_Error_Type_Is_Not_Equal_To_Expected() {
		...
		pack(optionPane, title());
		ExpectedException.assertOpenTest4jError(() -> driver.requirePlainMessage(optionPane), "Expected message type of 'TestOptionPane' to be 'Plain Message' but was 'Error Message'", "Plain Message", "Error Message");
	}
}
